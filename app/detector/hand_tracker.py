...
# obsluga braku biblioteki mediapipe przez lekki stub kompatybilny z jej api
try:  # pragma: no cover
    ...
    class _HandsStub:
        ...
        def process(self, frame_rgb):
            # zwraca None zamiast wynikow brak prawdziwej detekcji
            return None
    ...
    logger.warning("mediapipe niedostepne - uzywam pustego stuba (HandTracker)")
...
class HandTracker:
    def __init__(
        ...
        logger.info(
            f"HandTracker zainicjalizowany (max_hands={max_num_hands}, detect_conf={detection_confidence}, track_conf={tracking_confidence}, model_complexity={HAND_MODEL_COMPLEXITY})"
        )

    def process(self, frame_rgb: Any) -> None:
