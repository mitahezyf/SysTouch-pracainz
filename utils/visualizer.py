...
from config import LANDMARK_CIRCLE_RADIUS, LANDMARK_COLOR, CONNECTION_COLOR, LANDMARK_LINE_THICKNESS, LABEL_FONT_SCALE, \
    LABEL_THICKNESS
...
class Visualizer:
    ...
    def draw_label(self, frame, gesture_name, confidence, position=(10, 60)):
        ...
        cv2.putText(frame, label, position, cv2.FONT_HERSHEY_SIMPLEX, LABEL_FONT_SCALE, (255, 255, 255), LABEL_THICKNESS)
    ...
    def draw_frametime(self, frame, frametime_ms):
        ...
        cv2.putText(frame, text, (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
    ...
    def draw_landmarks(self, frame, hand_landmarks):
        mp_drawing.draw_landmarks(
            ...
            mp_drawing.DrawingSpec(color = LANDMARK_COLOR, thickness = LANDMARK_LINE_THICKNESS, circle_radius= LANDMARK_CIRCLE_RADIUS),
            mp_drawing.DrawingSpec(color = CONNECTION_COLOR, circle_radius= LANDMARK_LINE_THICKNESS)
        )
