...
# dystans poziomy miedzy (0,0) a (3,0) powinien wynosic 3
def test_distance_horizontal():
    p1 = make_point(0, 0)
    p2 = make_point(3, 0)
    assert distance(p1, p2) == 3

# trojkat prostokatny (0,0) - (3,4) ma długość 5
def test_distance_diagonal():
    p1 = make_point(0, 0)
    p2 = make_point(3, 4)
    assert distance(p1, p2) == 5

# punkty w jednej linii (p1 - p2 - p3) -> kat powinien być 180
...
# wektory prostopadłe -> kat powinien byc 90
